...
/* Enqueue:
Description - push new element to queue.
Params:
	queue_t *queue - management struct.
...
/* QueuePeek:
Description - returns the pointer to the value in the top of the queue.
Params:
...
/* QueueSize:
Description - returns how many elements in the queue.
Params:
	const queue_t *queue - management struct.
return value - size_t.
time complexity - O(n)
