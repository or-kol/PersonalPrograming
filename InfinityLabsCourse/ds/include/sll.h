...
/* type of the sll management struct */
...
/* SLLInsert:
Description - insert new valu to sll.
Params:
...
sll_t *SLLAppend(sll_t *sll_from, sll_t *sll_to);

sll_iterator_t SLLFindNthFromLast(const sll_t *sll, size_t n, sll_iterator_t *arr);
